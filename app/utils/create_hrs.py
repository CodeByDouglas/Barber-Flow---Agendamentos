...
def gerar_horarios_proximo_mes():
    """
    Gera registros de horários para todos os dias do próximo mês, das 8h às 18h,
    para cada funcionário (barbeiro) existente, mas somente se ainda não existirem registros
    para este período.
    """
